...
`continuity/ACTIVE_ROUND.md` é a autorização executável do Codex. Uma rodada só pode ficar `READY` quando o orquestrador tiver eliminado ambiguidades materiais.
...
- `BLOCKED_HUMAN`: todo trabalho independente terminou e resta gate humano explícito.
- `EXECUTED_AWAITING_REVIEW`: executor concluiu e persistiu; ainda não aceito.
...
13. política de commits e handoff;
14. pacote de revisão esperado.
